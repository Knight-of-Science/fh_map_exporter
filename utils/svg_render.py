...
# The "bridges_aim" layer is rendered procedurally by default. Legacy mode
# restores static SVG symbol stamping for that layer.
_PROCEDURAL_LAYERS = set() if ENABLE_LEGACY_BRIDGE_AIM else {"bridges_aim"}

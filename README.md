...
- [**fh_vehicle_classifier**](https://github.com/Knight-of-Science/fh_vehicle_classifier) - Identifies Foxhole vehicles from map intel screenshots through computer vision. Intended as a tool to summarize exciting vehicle battles without needing to enter the region first.
...
Each important depth gets a color swatch associated with how it is seen in the final render. Important depths that have their bands disabled or merged are indicated with a red 'X' in the swatch and "not shown" in the description.
...
**Thank you Tsekho for advancing the Foxhole map modding community by leaps and bounds.**

### Large Ship Draft Measurement Help
In order to measure the drafts of large ships and properties of submarines I consulted **Bullsaw**, a veteran among the colonial naval community.

Together we came up with methodology to determine large ship hull drafts from measurable aspects of submarines.

Additional assistance on update 64 dev branch by **JafShrimp**, **Dassity**, **Montag**, **Mr. Cuddlefish**, and **LuckyTheComet**.
